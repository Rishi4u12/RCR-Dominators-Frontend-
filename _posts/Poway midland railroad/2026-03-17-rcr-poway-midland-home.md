...
<style>
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .bg-scene {
    ...
    width: 100%; height: 100%;
    /* Railroad theme: dark sky fading to warm ground */
  ...
  .bg-hills {
    ...
    background: repeating-linear-gradient(
      118deg, #1a1208 0px, #1a1208 80px, #221608 80px, #221608 160px);
  ...
  .bg-glow {
    ...
    background: linear-gradient(180deg, transparent, rgba(185,74,28,0.08) 50%, transparent);
  }
  /* Rail track */
  .rail-track {
    position: absolute; bottom: 0; left: 0;
  ...
  /* Train wrapper */
  .train-wrapper {
    position: absolute; bottom: 22px; right: -500px;
